...
class aiassign_submission_onlinetext extends aiassign_submission_plugin
{
    ...
    private function get_onlinetext_submission($submissionid) {
        ...
        return $DB->get_record('aiassignsubmission_onlinetext', array('submission'=>$submissionid));
    }
    ...
    public function save(stdClass $submission, stdClass $data) {
        ...
        if ($onlinetextsubmission) {
            ...
            $updatestatus = $DB->update_record('aiassignsubmission_onlinetext', $onlinetextsubmission);
            ...
            $onlinetextsubmission->id = $DB->insert_record('aiassignsubmission_onlinetext', $onlinetextsubmission);
            $params['objectid'] = $onlinetextsubmission->id;
    ...
    public function view_summary(stdClass $submission, & $showviewlink) {
        ...
        if ($onlinetextsubmission) {
            ...
            $text = $this->assignment->render_editor_content(ASSIGNSUBMISSION_ONLINETEXT_FILEAREA,
                ...
                $this->get_type(),
                'onlinetext',
                'aiassignsubmission_onlinetext', true);
    ...
    public function upgrade(context $oldcontext,
        ...
        if (!$DB->insert_record('aiassignsubmission_onlinetext', $onlinetextsubmission) > 0) {
    ...
    public function delete_instance() {
        global $DB;
        $DB->delete_records('aiassignsubmission_onlinetext',
    ...
    public function copy_submission(stdClass $sourcesubmission, stdClass $destsubmission) {
        ...
        $fs = get_file_storage();
        $files = $fs->get_area_files($contextid, 'aiassignsubmission_onlinetext',
        ...
        if ($onlinetextsubmission) {
            ...
            $DB->insert_record('aiassignsubmission_onlinetext', $onlinetextsubmission);
        }
        return true;
    }
