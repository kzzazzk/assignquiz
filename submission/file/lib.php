 ...
 */
function aiassignsubmission_file_pluginfile($course,
                                          $cm,
                                          context $context,
                                          $filearea,
                                          $args,
    ...
    $assign = new aiassign($context, $cm, $course);
    ...
    $fullpath = "/{$context->id}/aiassignsubmission_file/$filearea/$itemid/$relativepath";
