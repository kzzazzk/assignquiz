...
class aiassign_submission_comments extends aiassign_submission_plugin
{
    ...
    public function get_name() {
        return get_string('pluginname', 'aiassignsubmission_comments');
    }
    ...
    public function view_summary(stdClass $submission, & $showviewlink) {
        ...
        $options->component = 'aiassignsubmission_comments';
