...
class aiquiz_access_manager {
    ...
    protected static function get_rule_classes() {
        $classes = core_component::get_plugin_list_with_class('aiquizaccess', '', 'rule.php');
        // Add your custom class if it is not detected automatically.
        $classes[] = 'aiquizaccess_seb';
        return $classes;    }
    ...
    public static function save_settings($quiz) {
        foreach (self::get_rule_classes() as $rule) {
            // Check if the current rule is aiquizaccess_seb and call its save_settings().
            if ($rule === 'aiquizaccess_seb') {
                aiquizaccess_seb::save_settings($quiz);
            } else {
